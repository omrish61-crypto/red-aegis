...
ARSENAL = [
    ...
    {"name": "eyewitness", "phase": "recon", "host": "kali", "probe": "eyewitness",
     ...
     "guardrail": "screenshots = human artifact, no parseable findings; installed 2026-08-10",
    ...
    {"name": "mimikatz", "phase": "privesc", "host": "kali", "probe": "mimikatz",
     ...
     "guardrail": "CREDENTIAL extraction — gated 'credential'; Windows post-exploitation on authorized hosts only (installed 2026-08-10, apt)",
    ...
    {"name": "rubeus", "phase": "privesc", "host": "kali", "probe": "rubeus",
     ...
     "guardrail": "CREDENTIAL — gated 'credential'; AD lab/authorized domains only; installed 2026-08-10 (prebuilt, symlink /opt/arsenal/Rubeus.exe — official GhostPack releases are source-only)",
    ...
    {"name": "winpeas", "phase": "privesc", "host": "kali", "probe": "winpeas",
     ...
     "guardrail": "read-only enumeration — run ON the target",
     "risk": None, "license": "GPL-2.0", "extractor": None},
    {"name": "bloodhound", "phase": "privesc", "host": "kali", "probe": "bloodhound",
     "purpose": "AD relationship graph analysis (Neo4j + UI)",
     "template": "bloodhound --no-sandbox",
     "guardrail": "read-only AD graph analysis; Neo4j 4.4.26 installed (2026-08-10)",
     "risk": None, "license": "Apache-2.0", "extractor": None},
    ...
    {"name": "impacket", "phase": "lateral", "host": "kali", "probe": "impacket-wmiexec",
     "purpose": "Python network protocol suite (wmiexec/secretsdump/samrdump)",
     "template": "impacket-psexec <user>@<target> cmd.exe",
     "guardrail": "standard lab lateral movement; secretsdump is gated 'credential'; installed 2026-08-10 (apt python3-impacket; psexec not in this build — wmiexec/secretsdump/samrdump/rpcdump/netview are)",
     "risk": None, "license": "Apache-2.0", "extractor": None},
    ...
    {"name": "chisel", "phase": "lateral", "host": "kali", "probe": "chisel",
     ...
     "guardrail": "tunnel endpoints remain scope-gated; v1.11.6 installed (2026-08-10)",
     "risk": None, "license": "MIT", "extractor": None},
